  ...
  const translations = {
    nl: {
      ...
      'lbl-live-queue-header': 'Live Wachtrij',
      'lbl-sort-chrono': 'Chrono',
      'lbl-sort-popular': 'Populair',
      'lbl-sort-custom': 'Eigen',
      ...
      'lbl-song-ug': 'Tabs / Akkoorden URL',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Songbook importeren via CSV',
      'lbl-csv-hint': 'Minimaal Titel en Artiest zijn verplicht, de rest is optioneel.',
      'lbl-download-template': 'Download template',
      'lbl-csv-upload-text': 'Klik om een CSV-bestand te kiezen',
      'lbl-confirm-csv': 'Importeer',
      'btn-cancel-csv': 'Annuleren',
      ...
      'lbl-have-code': 'Ik heb al een code →',
      'lbl-artist-check-email': 'Check je e-mail',
      'lbl-artist-code-sent': 'We hebben een 8-cijferige code gestuurd',
      ...
      'seo-heading': 'Song requests voor live optredens',
      'seo-body': 'JukeStage laat jouw publiek nummers aanvragen en stemmen — vooraf én tijdens je optreden. Jij ziet live welke nummers het meest gewild zijn en speelt in op wat er leeft.',
      'seo-feat1': 'Publiek vraagt nummers aan via QR-code — geen app nodig',
      'seo-feat2': 'Stemmen op elkaars verzoekjes, vooraf én live',
      'seo-feat3': 'Jij ziet realtime wat het publiek wil horen',
      'seo-feat4': 'Ideaal voor cafégigs, bruiloften en liveshows',
      'seo-cta': 'Probeer het gratis — geen account nodig voor je publiek.',
    ...
    en: {
      ...
      'lbl-live-queue-header': 'Live Queue',
      'lbl-sort-chrono': 'Chrono',
      'lbl-sort-popular': 'Popular',
      'lbl-sort-custom': 'Custom',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Import songbook via CSV',
      'lbl-csv-hint': 'Title and Artist are required, everything else is optional.',
      'lbl-download-template': 'Download template',
      'lbl-csv-upload-text': 'Click to choose a CSV file',
      'lbl-confirm-csv': 'Import',
      'btn-cancel-csv': 'Cancel',
      ...
      'lbl-have-code': 'I already have a code →',
      'lbl-artist-check-email': 'Check your email',
      'lbl-artist-code-sent': 'We sent you an 8-digit code',
      ...
      'seo-heading': 'Song requests for live performances',
      'seo-body': 'JukeStage lets your audience request songs and vote — before and during your show. See in real time which songs are most wanted and play what the crowd wants to hear.',
      'seo-feat1': 'Audience requests songs via QR code — no app needed',
      'seo-feat2': 'Vote on each other\'s requests, before and during the show',
      'seo-feat3': 'You see in real time what the audience wants to hear',
      'seo-feat4': 'Perfect for pub gigs, weddings and live shows',
      'seo-cta': 'Try it for free — no account needed for your audience.',
    ...
    fr: {
      ...
      'lbl-live-queue-header': 'File en direct',
      'lbl-sort-chrono': 'Chrono',
      'lbl-sort-popular': 'Populaire',
      'lbl-sort-custom': 'Personnalisé',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Importer le répertoire via CSV',
      'lbl-csv-hint': 'Titre et Artiste sont obligatoires, le reste est optionnel.',
      'lbl-download-template': 'Télécharger le modèle',
      'lbl-csv-upload-text': 'Cliquez pour choisir un fichier CSV',
      'lbl-confirm-csv': 'Importer',
      'btn-cancel-csv': 'Annuler',
      ...
      'lbl-have-code': "J'ai déjà un code →",
      'lbl-artist-check-email': 'Vérifiez vos e-mails',
      'lbl-artist-code-sent': 'Nous vous avons envoyé un code à 8 chiffres',
      ...
      'seo-heading': 'Demandes de chansons pour spectacles live',
      'seo-body': 'JukeStage permet à votre public de demander des chansons et de voter — avant et pendant votre concert. Voyez en temps réel quelles chansons sont les plus demandées.',
      'seo-feat1': 'Le public demande des chansons via QR code — aucune app nécessaire',
      'seo-feat2': 'Voter sur les demandes des autres, avant et pendant le show',
      'seo-feat3': 'Vous voyez en temps réel ce que le public veut entendre',
      'seo-feat4': 'Idéal pour les concerts en bar, mariages et spectacles live',
      'seo-cta': 'Essayez gratuitement — aucun compte nécessaire pour votre public.',
    ...
    de: {
      ...
      'lbl-live-queue-header': 'Live-Warteschlange',
      'lbl-sort-chrono': 'Chrono',
      'lbl-sort-popular': 'Beliebt',
      'lbl-sort-custom': 'Eigene',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Songbook per CSV importieren',
      'lbl-csv-hint': 'Titel und Künstler sind Pflichtfelder, der Rest ist optional.',
      'lbl-download-template': 'Vorlage herunterladen',
      'lbl-csv-upload-text': 'Klicken, um eine CSV-Datei auszuwählen',
      'lbl-confirm-csv': 'Importieren',
      'btn-cancel-csv': 'Abbrechen',
      ...
      'lbl-have-code': 'Ich habe bereits einen Code →',
      'lbl-artist-check-email': 'E-Mails checken',
      'lbl-artist-code-sent': 'Wir haben dir einen 8-stelligen Code gesendet',
      ...
      'seo-heading': 'Song-Wünsche für Live-Auftritte',
      'seo-body': 'JukeStage lässt dein Publikum Songs wünschen und abstimmen — vor und während deines Auftritts. Sieh live, welche Songs am meisten gewünscht werden.',
      'seo-feat1': 'Publikum wünscht Songs per QR-Code — keine App nötig',
      'seo-feat2': 'Über Wünsche anderer abstimmen, vorher und live',
      'seo-feat3': 'Du siehst in Echtzeit, was das Publikum hören will',
      'seo-feat4': 'Ideal für Kneipen-Gigs, Hochzeiten und Live-Shows',
      'seo-cta': 'Kostenlos ausprobieren — kein Konto nötig für dein Publikum.',
    ...
    es: {
      ...
      'lbl-live-queue-header': 'Cola en vivo',
      'lbl-sort-chrono': 'Crono',
      'lbl-sort-popular': 'Popular',
      'lbl-sort-custom': 'Propio',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Importar repertorio via CSV',
      'lbl-csv-hint': 'Título y Artista son obligatorios, el resto es opcional.',
      'lbl-download-template': 'Descargar plantilla',
      'lbl-csv-upload-text': 'Haz clic para elegir un archivo CSV',
      'lbl-confirm-csv': 'Importar',
      'btn-cancel-csv': 'Cancelar',
      ...
      'lbl-have-code': 'Ya tengo un código →',
      'lbl-artist-check-email': 'Revisa tu e-mail',
      'lbl-artist-code-sent': 'Te enviamos un código de 8 dígitos',
      ...
      'seo-heading': 'Peticiones de canciones para actuaciones en vivo',
      'seo-body': 'JukeStage permite a tu público pedir canciones y votar — antes y durante tu actuación. Ve en tiempo real qué canciones son las más pedidas.',
      'seo-feat1': 'El público pide canciones con código QR — sin app',
      'seo-feat2': 'Votar las peticiones de otros, antes y durante el show',
      'seo-feat3': 'Ves en tiempo real lo que el público quiere escuchar',
      'seo-feat4': 'Ideal para bares, bodas y espectáculos en vivo',
      'seo-cta': 'Pruébalo gratis — tu público no necesita cuenta.',
    ...
    mg: {
      ...
      'lbl-live-queue-header': 'Lisitra velona',
      'lbl-sort-chrono': 'Chrono',
      'lbl-sort-popular': 'Malaza',
      'lbl-sort-custom': 'Manokana',
      ...
      'lbl-import-csv': '↑ CSV',
      'lbl-csv-modal-title': 'Mampiditra repertoire amin\'ny CSV',
      'lbl-csv-hint': 'Lohateny sy Mpanakanto no tsy maintsy, ny sisa dia tsy voatery.',
      'lbl-download-template': 'Hisintona ny modely',
      'lbl-csv-upload-text': 'Tsindrio mba hifidy rakitra CSV',
      'lbl-confirm-csv': 'Ampiditra',
      'btn-cancel-csv': 'Hanafoana',
      ...
      'lbl-have-code': 'Manana kaody aho →',
      'lbl-artist-check-email': 'Jereo ny e-mail',
      'lbl-artist-code-sent': 'Nalefanay kaody 8 isa ho anao',
      ...
      'seo-heading': 'Fangatahana hira ho an\'ny fampisehoana velona',
      'seo-body': 'JukeStage mamela ny mpihaino anao hangataka hira sy hifidy — mialoha sy mandritra ny fampisehoana. Jereo mivantana izay hira tian\'ny olona indrindra.',
      'seo-feat1': 'Ny mpihaino mangataka hira amin\'ny QR code — tsy mila app',
      'seo-feat2': 'Mifidy ny fangataham-pihaino hafa, mialoha sy velona',
      'seo-feat3': 'Hitanao mivantana izay tian\'ny mpihaino hohenoina',
      'seo-feat4': 'Tonga lafatra ho an\'ny gig, mariazy sy fampisehoana velona',
      'seo-cta': 'Andramo maimaim-poana — tsy mila kaonty ny mpihaino anao.',
